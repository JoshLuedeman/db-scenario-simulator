...
- **Label Taxonomy:** type/bug, type/feature, type/chore, priority/critical, priority/high, priority/medium, priority/low, area/backend, area/frontend, area/scenarios, area/docker
- **Priority Levels:** critical, high, medium, low
- **Workflows:** bug → bug-fix, feature → planning, chore → direct implementation
